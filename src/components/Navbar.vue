  ...
  <div id="nav">
    <nav class="flex items-center justify-between flex-wrap bg-red-500 p-6">
        ...
        <div class="text-sm sm:flex-grow">
            ...
            <router-link class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white mr-4" to="/">Home</router-link>
            <router-link class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white mr-4" to="/about">About</router-link>
            <a href="#responsive-header" class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white mr-4">
            Examples
            </a>
